...
class CardComponent extends Component {
      ...
      if (this.props.app.paramConfig) {
        let chart = {
          ...
          dataSet: {
            ...
            chartBackgroundColor: ["rgba(64,211,212,0.50)"], //["rgba(204,91,68,0.20)"],
            chartBorderColor: [
              "#ff0000",
              "#ff0000",
              "#ff0000",
  ...
  render() {
    ...
    if (this.state.cardList !== undefined && this.state.cardList.length >= 5) {
      return (
        <div className="site-card-wrapper" style={{ color: "white" }}>
          <Row gutter={16}>
            {this.state.cardList
              ? this.state.cardList.map((it, y) => {
                  console.log(it.dataSet.chartBackgroundColor);
                  return (
                    <Col span={8}>
